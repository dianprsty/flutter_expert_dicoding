...
void main() {
  ...
  group('Now Playing Movies', () {
    test('should return remote data when the call to '
        'remote data source is successful', () async {
      // arrange
      when(
    ...
    test('should return server failure when the call to '
    ...
    test('should return connection failure when '
  ...
  group('Top Rated Movies', () {
    ...
    test('should return ConnectionFailure when '
        'device is not connected to the internet', () async {
      // arrange
      when(
        mockRemoteDataSource.getTopRatedMovies(),
  ...
  group('Get Movie Detail', () {
    ...
    test('should return Movie data when '
    ...
    test('should return Server Failure when '
  ...
  group('Get Movie Recommendations', () {
    ...
    test('should return data (movie list) when '
        'the call is successful', () async {
      // arrange
      when(
