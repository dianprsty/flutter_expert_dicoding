...
void main() {
  ...
  testWidgets('Drawer should display app info', (WidgetTester tester) async {
    await tester.pumpWidget(makeTestableWidget(AppDrawer()));

    expect(find.text('Ditonton'), findsOneWidget);
    expect(find.text('ditonton@dicoding.com'), findsOneWidget);
  });

  testWidgets('Drawer should navigate to TV Series page when '
      'TV Series menu is tapped', (WidgetTester tester) async {
  ...
  testWidgets(
    'Drawer should navigate to Movies page when Movies menu is tapped',
  ...
  testWidgets(
    'Drawer should navigate to Watchlist page when Watchlist menu is tapped',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          initialRoute: '/',
  ...
  testWidgets(
    'Drawer should navigate to About page when About menu is tapped',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          initialRoute: '/',
